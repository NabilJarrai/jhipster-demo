  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="blogApp.entry.home.createOrEditLabel" data-cy="EntryCreateUpdateHeading">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : entryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="entry-blog" data-cy="blog" type="select" className="form-control" name="blogId">
                  <option value="" key="0" />
                  {blogs
              ...
              <AvGroup>
                ...
                <AvInput
                  ...
                  className="form-control"
                  name="tags"
                  value={!isNew && entryEntity.tags && entryEntity.tags.map(e => e.id)}
                >
                  <option value="" key="0" />
                  {tags
