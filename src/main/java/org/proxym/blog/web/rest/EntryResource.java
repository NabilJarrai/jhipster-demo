...
import org.proxym.blog.domain.Entry;
import org.proxym.blog.repository.EntryRepository;
...
/**
 * REST controller for managing {@link org.proxym.blog.domain.Entry}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EntryResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/entries/{id}", consumes = "application/merge-patch+json")
